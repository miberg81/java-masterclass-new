...
ChallengeStudent {
    ...
    public ChallengeStudent(String countryCode, int yearEnrolled, int ageEnrolled, String gender,
    ...
    public static ChallengeStudent getRandomStudent(Course... courses) {

        int maxYear = LocalDate.now().getYear() + 1;

        ChallengeStudent student = new ChallengeStudent(
    ...
    public static ChallengeStudent getRandomStudent() {

        List<Course> coursesList = Arrays.asList(
                new Course("PYMC", "Python Masterclass", 45),
                new Course("JMC", "Java Masterclass", 56),
                new Course("JSMC", "JavaScript Masterclass", 78),
                new Course("RMC", "Ruby Masterclass", 99),
                new Course("SMC", "Scala Masterclass", 345)
        );

        Course[] courses = getRandomCourses(coursesList);
    ...
    private static Course[] getRandomCourses(List<Course> coursesList) {
        int randomNumOfCourses = random.nextInt(1, 6);
        List<Course> list = coursesList.subList(0, randomNumOfCourses);
