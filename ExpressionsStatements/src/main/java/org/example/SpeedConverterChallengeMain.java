...
to indicate an invalid value. Otherwise, if it is positive, calculate the value of miles per hour, round it and return it.
...
roundedAverage= 5
 */
public class SpeedConverterChallengeMain {
...
//        System.out.println(toMilesPerHour(75.114)); //→ should return value 47
    ...
    public static long toMilesPerHour(double kilometersPerHour) {
        ...
        return Math.round(kilometersPerHour / mileToKm);
    }
    ...
    public static void printConversion(double kilometersPerHour) {
        ...
        System.out.printf("%.2f km/h = %d mi/h%n", kilometersPerHour, result);
    }
}